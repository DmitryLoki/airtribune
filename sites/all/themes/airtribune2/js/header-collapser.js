jQuery(function ($) {
    ...
    $('.page-event-pilots, .page-user, .node-type-accommodation, .node-type-activity, .page-account, .page-retrieve-table, .page-event-race-results').find('.featured-header').addClass('featured-header-collapsed');
