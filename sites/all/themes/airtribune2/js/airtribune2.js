(function ($) {
  Drupal.behaviors.airtribune2 = {
    attach: function (context) {
      ...
      $('.pane-menu-footer-menu a.link-disable, .pane-airtribune-primary-navigation .menu-item-1338 a, .pane-airtribune-primary-navigation .menu-item-1339 a, .pane-airtribune-primary-navigation .menu-item-1340 a, .pane-airtribune-primary-navigation .menu-item-1341 a')
