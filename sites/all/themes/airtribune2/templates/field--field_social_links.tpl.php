  ...
  <div class="field-items"<?php print $content_attributes; ?>>
    <?php foreach ($items as $delta => $item) : ?>
      <div class="field-item <?php print $delta % 2 ? 'odd' : 'even'; ?>"<?php print $item_attributes[$delta]; ?>>    
        ...
        if (strpos($url, 'facebook.com'))    {print "<a href='$url' class='facebook-icon'><img src='/sites/all/themes/airtribune2/images/touch-icon-h.png'></a>";}
        if (strpos($url, 'twitter.com'))     {print "<a href='$url' class='twitter-icon'><img src='/sites/all/themes/airtribune2/images/touch-icon-h.png'></a>";}
        if (strpos($url, 'plus.google.com')) {print "<a href='$url' class='google-icon'><img src='/sites/all/themes/airtribune2/images/touch-icon-h.png'></a>";}
        if (strpos($url, 'youtube.com'))     {print "<a href='$url' class='youtube-icon'><img src='/sites/all/themes/airtribune2/images/touch-icon-h.png'></a>";}
        if (strpos($url, 'vimeo.com'))       {print "<a href='$url' class='vimeo-icon'><img src='/sites/all/themes/airtribune2/images/touch-icon-h.png'></a>";}
        ?>
      </div>
    <?php endforeach; ?>
  </div>
