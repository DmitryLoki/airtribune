...
<div class="at-panel panel-display fourcoltworow clearfix" <?php if (!empty($css_id)): print "id=\"$css_id\""; endif; ?>>
  <div class="panel-row-100 row-100-1 clearfix">
    <div class="panel-row row-1 clearfix">
      <div class="region region-four-first col">
        <div class="region-inner clearfix">
          <?php print $content['four_first']; ?>
        </div>
      </div>
      <div class="region region-four-second col">
        <div class="region-inner clearfix">
    ...
    <div class="panel-row row-2 clearfix">
      <div class="region region-four-third col">
        <div class="region-inner clearfix">
          <?php print $content['four_third']; ?>
        </div>
      </div>
      <div class="region region-four-fourth col">
        <div class="region-inner clearfix">
  ...
  <div class="panel-row-100 row-100-2 clearfix">
    <div class="region region-four-five">
      <div class="region-inner clearfix">
        <?php print $content['four_five']; ?>
      </div>
    </div>
  </div>
</div>
